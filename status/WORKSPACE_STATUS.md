...
- Next active local implementation lane: tranche C of the next-20 wave. Tranches A and B are closed locally, including `clojure-stakeholder`, `c-stakeholder`, `cpp-stakeholder`, `powershell-stakeholder`, and `perl-stakeholder`.
